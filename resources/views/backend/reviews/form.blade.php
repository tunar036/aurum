        ...
        <div class="d-flex flex-column-fluid">
            <div class="container">
                <div class="card card-custom example example-compact">
                    @include('backend.includes.form.header', ['page' => 'reviews'])
                    <form
                        action="{{ $edit === false ? route('backend.reviews.store') : route('backend.reviews.update', ['review' => $review->id]) }}"
                                            ...
                                            <div class="col-lg-6 col-md-9 col-sm-12">
                                                <div class="input-group">
                                                    <input id="name:{{ $lang->code }}" type="text"
                                                        ...
                                                        name="name:{{ $lang->code }}"
                                                        value="{{ isset($review) ? $review->translate($lang->code)->name : old('name:' . $lang->code) }}"
                                            ...
                                            <div class="col-lg-6 col-md-9 col-sm-12">
                                                <div class="input-group">
                                                    <input id="title:{{ $lang->code }}" type="text"
                                                        ...
                                                        value="{{ isset($review) ? $review->translate($lang->code)->title : old('title:' . $lang->code) }}"
                                            ...
                                            <div class="col-lg-6 col-md-9 col-sm-12">
                                                <div class="input-group">
                                                    <input id="description:{{ $lang->code }}" type="text"
                                                        ...
                                                        value="{{ isset($review) ? $review->translate($lang->code)->description : old('description:' . $lang->code) }}"
                                        ...
                                        <span class="switch switch-md switch-icon">
                                            <label>
                                                <input type="checkbox" class="bool" name="status"
                                                    value="{{ old('status', '1') }}"
                                                    {{ old('status', $review->status ?? '1') == 1 ? 'checked' : '' }}>
                                                <span></span>
                                            </label>
                                        </span>
                                    </div>
                    ...
                    {{-- <div class="card-body">
                        @if ($edit)
                            @include('backend.includes.media', [
                                'model' => $review,
                                'name' => 'reviews',
                                'media_collection_name' => 'review_icon',
                                'isDeleted' => true,
                                'isCovered' => false,
                            ])
                        @endif
