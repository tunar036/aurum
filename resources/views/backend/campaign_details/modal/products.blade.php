    ...
    <div class="modal-dialog modal-dialog-centered modal-xl text-center" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Kompaniyaya uyğun məhsul seç</h5>
                        ...
                        <div class="col-md-12">
                            <table class="table table-bordered table-hover table-striped table-sm text-center">
                                ...
                                <tr v-for="product in products" @key="product.id">
                                    ...
                                    <td>
                                        <a ref="ref" href="javascript:void(0)" @click.preventDefault="addSelectedProduct(product)" class="btn btn-success btn-sm"><i class="fa fa-plus"></i> Əlavə et</a>
