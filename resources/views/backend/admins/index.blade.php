        ...
        <div class="d-flex flex-column-fluid">
            <div class="container">
                <div class="card card-custom">
                    @include('backend.includes.card.header', ['page' => 'admins'])
...
@section('scripts')
    ...
    @include('backend.includes.plugins.datatable',['columns'=>['id','name','email','role','status','actions'], 'route'=>route('backend.admins.index')])
@endsection
