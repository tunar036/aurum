        ...
        <div class="d-flex flex-column-fluid">
            <div id="app" class="container">
                <div class="card card-custom example example-compact">
                    @include('backend.includes.form.header', ['page' => 'campaign_types'])
                    <form action="{{ $edit === false ? route('backend.campaign_types.store') : route('backend.campaign_types.update', ['campaign_type' => $campaign_type->id])  }}"
                                ...
                                <div class="col-lg-6 col-md-9 col-sm-12">
                                    <div class="input-group">
                                         <span class="switch switch-md switch-icon">
                                             <label>
                                                 <input type="checkbox" class="bool" name="status" value="{{ isset($campaign_type) ? $campaign_type->status : 1 }}" @if(isset($campaign_type) && $campaign_type->status) checked @endif checked>
                                                 <span></span>
                                             </label>
                                         </span>
                                    </div>
