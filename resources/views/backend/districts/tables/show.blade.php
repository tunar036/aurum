    ...
    <table class="table table-hover table-rounded border gy-7 gs-7">
            <tbody>
                <tr class="fw-bold fs-6 text-gray-800 border-bottom-2 border-gray-200">
                    ...
                    <td class="table-center">{{ $district->id }}</td>
                </tr>
                    <tr class="fw-bold fs-6 text-gray-800 border-bottom-2 border-gray-200">
                        <td class="table-row-title w-25">@lang('backend.labels.name')</td>
                        <td class="table-center">{{ $district->transname ?? "-"  }}</td>
                    </tr>
                <tr class="fw-bold fs-6 text-gray-800 border-bottom-2 border-gray-200">
                    <td class="table-row-title w-25">@lang('backend.labels.status')</td>
                    <td class="table-center">{!! badge($district->status) !!}</td>
                </tr>
                <tr class="fw-bold fs-6 text-gray-800 border-bottom-2 border-gray-200">
                    <td class="table-row-title w-25">
                        @lang('backend.labels.created_at')
                    </td>
                    <td class="table-center">{{ $district->created_at->format('d-m-Y H:i:s') }}</td>
                </tr>
                ...
                <tr class="fw-bold fs-6 text-gray-800 border-bottom-2 border-gray-200">
                    ...
                    <td class="table-center">{{ $district->updated_at->format('d-m-Y H:i:s') }}</td>
                </tr>
            </tbody>
        </table>
