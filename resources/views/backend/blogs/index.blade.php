        ...
        <div class="d-flex flex-column-fluid">
            <div class="container">
                <div class="card card-custom">
                    @include('backend.includes.card.header', ['page' => 'blogs'])
...
@section('scripts')
    ...
    @include('backend.includes.plugins.datatable',['columns'=>['id','image','name','status','created_at','actions'], 'route'=>route('backend.blogs.index')])
@endsection
