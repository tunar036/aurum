        ...
        <div class="d-flex flex-column-fluid">
            <div id="app" class="container">
                <div class="card card-custom example example-compact">
                    ...
                    <form action="{{ $edit === false ? route('backend.campaigns.store') : route('backend.campaigns.update', ['campaign' => $campaign->id])  }}"
                                ...
                                @foreach ($langs as $lang)
                                    <div class="tab-pane fade @if($loop->first) active show @endif"
                                        ...
                                        <div class="form-group row">
                                            <label for="note"
                                                   class="col-form-label text-right col-lg-3 col-sm-12 col-form-label">
                                                Qeydlər ({{ strtoupper($lang->code) }})
                                            </label>
                                            <div class="col-lg-6 col-md-9 col-sm-12">
                                                <div class="input-group">
                                                   <textarea id="note"
                                                             class="summernote @if($errors->has("note:$lang->code")) is-invalid @endif"
                                                             name="note:{{ $lang->code }}"
                                                             placeholder="@lang('backend.placeholders.enter.note')">
                                                      {!! isset($campaign) ? $campaign->translate($lang->code)->note : old('note:'.$lang->code) !!}
                                                   </textarea>`
                                                    @if ($errors->has("note:$lang->code"))
                                                        <div class="invalid-feedback">{{ $errors->first("note:$lang->code") }}</div>
                                                    @endif
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="col-lg-6 col-md-9 col-sm-12">
                                    <div class="input-group">
                                         <span class="switch switch-md switch-icon">
                                             <label>
                                                 <input type="checkbox" class="bool" name="status" value="{{ isset($campaign) ? $campaign->status : 1 }}" @if(isset($campaign) && $campaign->status) checked @endif checked>
                                                 <span></span>
                                             </label>
                                         </span>
                                    </div>
